...
Nova pergunta: Com o intuito de certificar se existe ou não uma relação entre a classificacao dos usuarios segundo o IMDB (UserRating) e o numero de votos dos usuarios (UserVotes), qual o coeficiente de corelacao linear entre essas duas variaveis?
```{r}
