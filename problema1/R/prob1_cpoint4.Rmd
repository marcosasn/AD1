...
dados %>%
  ...
  labs(title = "Distribuicao de votos do usuario", x="Nome da serie", y="Votos do usuario")
```
Podemos perceber que segundo a distribuicao de votos do usuarios do IMDB acima, Black Mirror tem votos dispersos. Em termos de media temos 12336.62 e de mediana 11844.
```{r}
