...
dados %>%
  ...
  labs(title = "Distribuicao da classificacao do usuario", x="Nome da serie", y="Classificacao do usuario")
```
Podemos perceber que segundo a classificacao de usuarios IMDB acima, 13 Reasons Why nao possui valores estranhos. Existe pouca variacao se comparado as séries Sense8 e Black Mirror e dentre os valores frequentes temos as classificacoes de 8.5. Isto fica ainda mais claro no histograma abaixo.
