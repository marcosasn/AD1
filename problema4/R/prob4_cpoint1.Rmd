...
# Mais filmes! Como se comportam as avaliações dos filmes de Resident Evil? 
...
for(i in 1:6){
  b = bootstrap(subset(dados3, nGenre==i) , median(medianRating))
...
df %>% 
  ...
  labs(x="Quantidade de gêneros", y="Mediana")
```
