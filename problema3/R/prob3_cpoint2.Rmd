...
dw2.scaled.km.long %>% 
    ...
    xlab("Variável") + 
    ylab("Valor") +
    ggtitle("Distribuição das dimensões por cluster") +
  theme(plot.title = element_text(hjust = 0.5))
...
Observando os agrupamentos acima podemos notar que: o grupo 1 é caracterizado por conter mais personagens do sexo feminino do que por personagens de sexo masculino embora ambos os sexos falem a mesma quantidade de palavras em termos de mediana.

O grupo 2 é caracterizado por conter mais personagens do sexo feminino do que personagens do sexo masculino embora os personagens do sexo masculino falem mais do que os personagens do sexo feminino em termos de mediana.

O grupo 3 é caracterizado por conter mais personagens do sexo masculino do que personagens do sexo feminino. Neste grupo os homens falam mais quantidade de palavras do que as mulheres.

O grupo 4 é caracterizado por conter mais personagens do sexo masculino do que personagens do sexo feminino embora a quantidade de palavras ditas pelas mulheres seja maior do que a quantidade de palavras ditas por homens.
...
p <- km %>% 
    ...
    plot_ly(type = 'parcoords',
            ...
            dimensions = list(
                ...
                list(range = c(-3, 3),
                     label = "Nº mulheres", values = ~n_f),
                list(range = c(-3, 3),
                     label = "Palavras mulheres", values = ~words_f),
                list(range = c(-6, 3),
                     label = "Nº homens", values = ~n_m),
                list(range = c(-2, 3),
...
Copyright © 2017 [Marcos Nascimento](http://https://github.com/marcosasn/AD1/tree/master/problema3/R)